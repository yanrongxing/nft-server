...
import { getMarketplaceChainId, getCollectionsChainId, getMarketplaceChainName } from './logic/chainIds'
...
async function initComponents(): Promise<AppComponents> {
  ...
  // chain ids
  const marketplaceChainName = getMarketplaceChainName()
